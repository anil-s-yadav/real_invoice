                        ...
                        children: [
                          Container(
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: const Color(0xFF003DFF).withValues(alpha: 0.15),
                                  blurRadius: 20,
        ...
        children: [
          ...
          Positioned(
            ...
            child: Transform.rotate(
              angle: 0.3,
              child: Container(width: 4, height: 16, decoration: BoxDecoration(color: Colors.blueAccent, borderRadius: BorderRadius.circular(2))),
            ),
          ),
          Positioned(
            top: 55,
            ...
            child: Transform.rotate(
              angle: 0.8,
              child: Container(width: 4, height: 12, decoration: BoxDecoration(color: Colors.blueAccent, borderRadius: BorderRadius.circular(2))),
            ),
          ),
          Positioned(
            top: 90,
            ...
            child: Transform.rotate(
              angle: 1.2,
              child: Container(width: 4, height: 10, decoration: BoxDecoration(color: Colors.blueAccent, borderRadius: BorderRadius.circular(2))),
            ),
          ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Container(width: 60, height: 6, decoration: BoxDecoration(color: const Color(0xFFE2E8F0), borderRadius: BorderRadius.circular(3))),
                            const SizedBox(height: 6),
                            Container(width: 40, height: 6, decoration: BoxDecoration(color: const Color(0xFFE2E8F0), borderRadius: BorderRadius.circular(3))),
                          ],
                        ),
                      )
                    ],
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const Spacer(),
                            Container(width: 15, height: 4, decoration: BoxDecoration(color: const Color(0xFFCBD5E1), borderRadius: BorderRadius.circular(2))),
                            const SizedBox(width: 8),
                          ],
                        ),
                        Row(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: Container(width: 16, height: 4, decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(2))),
                      ),
                    ],
                  ),
                ],
            ...
            child: Transform.rotate(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(color: const Color(0xFF059669).withValues(alpha: 0.3), blurRadius: 15, offset: const Offset(0, 8))
                  ],
                ),
            ...
            child: Transform.rotate(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  boxShadow: [
                    BoxShadow(color: const Color(0xFF7C3AED).withValues(alpha: 0.3), blurRadius: 15, offset: const Offset(0, 8))
                  ],
                ),
            ...
            child: Transform.rotate(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  boxShadow: [
                    BoxShadow(color: const Color(0xFFF59E0B).withValues(alpha: 0.3), blurRadius: 15, offset: const Offset(0, 8))
                  ],
                ),
...
class _SquigglePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.6, size.height * 0.1, size.width * 0.8, size.height * 0.8);
